...
public partial class Pages1_Schedule : System.Web.UI.Page
{
    ...
    {
        // gets a rule engine
        RulesEngine rulesEngine = WebApplication.RulesEngines["DataCollectorAssignment"];
        ...
        Entity orgStruct = WebApplication.Entities["4cda22f3-4f01-4768-8608-938dc6a06825"];
        if (orgStruct != null)
        {
