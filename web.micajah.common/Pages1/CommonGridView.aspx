...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <mits:ComboBox ID="ComboBox1" runat="server" Required="True" ErrorMessage="You must select an item"
        ValidatorInitialValue="0" DataSourceID="ObjectDataSource6" DataTextField="Name"
        DataValueField="RoleId" Width="250px">
    </mits:ComboBox>
    ...
    <mits:CommonGridView ID="CommonGridView1" runat="server" PageSize="2" AllowPaging="True"
        ...
        <Columns>
            ...
            <mits:ButtonField Text="Link1" HeaderText="Link1 Caption" CreateNewRow="True" ItemStyle-CssClass="Command">
            </mits:ButtonField>
    ...
    <mits:CommonGridView ID="CommonGridView5" runat="server" Width="100%" DataSourceID="ObjectDataSource4"
        ...
        ColorScheme="Yellow" ShowAddLink="true" AddLinkCssClass="Gray" Caption="Standard grid" AutoGenerateDeleteButton="true"
