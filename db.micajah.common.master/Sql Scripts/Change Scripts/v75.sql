...
IF @@TRANCOUNT = 1
   ...
   [SimpleId] [varchar] (8) NOT NULL CONSTRAINT [DF_Mc_Organization_PseudoUniqueId] DEFAULT (''),
...
IF @@TRANCOUNT = 1
   INSERT INTO [dbo].[tmp_Mc_Organization] ([OrganizationId], [Name], [Description], [WebsiteUrl], [DatabaseId], [FiscalYearStartDay], [FiscalYearStartMonth], [WeekStartsDay], [LdapServerAddress], [LdapServerPort], [LdapDomain], [LdapUserName], [LdapPassword], [LdapDomains], [ExpirationTime], [GraceDays], [Active], [Deleted])
...
BEGIN
	...
	SELECT OrganizationId, SimpleId, [Name], [Description], WebsiteUrl, DatabaseId
...
BEGIN
	...
	INSERT INTO dbo.Mc_Organization (OrganizationId, SimpleId, [Name], [Description], WebsiteUrl, DatabaseId, FiscalYearStartMonth, FiscalYearStartDay, WeekStartsDay, ExpirationTime, GraceDays, Active, Deleted) 
	VALUES (@OrganizationId, @SimpleId, @Name, @Description, @WebsiteUrl, @DatabaseId, @FiscalYearStartMonth, @FiscalYearStartDay, @WeekStartsDay, @ExpirationTime, @GraceDays, @Active, @Deleted);
...
BEGIN
	...
	SET SimpleId  = @SimpleId, [Name] = @Name, [Description] = @Description, WebsiteUrl = @WebsiteUrl, DatabaseId = @DatabaseId
