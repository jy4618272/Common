...
namespace Micajah.Common.Tools.UploadResourcesToAzure.MasterDataSetTableAdapters {
...
SELECT TOP (1000) ResourceId, LocalObjectType, LocalObjectId, NULL AS Content, ContentType, Name FROM Mc_Resource WHERE (ResourceId = @ResourceId) ORDER BY LocalObjectType, LocalObjectId";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Micajah.Common.Tools.UploadResourcesToAzure.Properties.Settings.Default.Mc_MasterConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        TOP (1000) ResourceId, LocalObjectType, LocalObjectId, NULL AS Content, ContentType, Name
FROM            Mc_Resource
WHERE        (ParentResourceId IS NULL) AND (Temporary = 0) AND (UploadStatus IS NULL)
ORDER BY LocalObjectType, LocalObjectId";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        [Content]\r\nFROM            Mc_Resource\r\nWHERE        (ResourceId = " +
                "@ResourceId)";
