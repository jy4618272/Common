...
"
        ...
        {
            UpdateButton.Text = MagicForm.GetUpdateButtonText(DetailsViewMode.Edit, string.Empty, InsertButtonCaptionType.Create, UpdateButtonCaptionType.Save, CloseButtonVisibilityMode.Edit);
