...
namespace Micajah.Common.WebControls.AdminControls
{
    ...
    public class LogosControl : BaseControl
    {
        ...
        protected override void LoadResources()
        {
            ...
            ((CommandField)List.Columns[3]).EditText = Resources.LogosControl_List_CommandColumn_EditText;
        }
        ...
        protected void List_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                List.SelectedIndex = Convert.ToInt32(e.CommandArgument.ToString());
                List.Visible = false;
        ...
        {
            if (this.SelectedObjectType == "OrganizationLogo")
