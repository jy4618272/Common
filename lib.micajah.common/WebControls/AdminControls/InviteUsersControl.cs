...
namespace Micajah.Common.WebControls.AdminControls
{
    public class InviteUsersControl : UserControl
    {
        ...
        protected void SendButton_Click(object sender, EventArgs e)
        {
            ...
            WebApplication.LoginProvider.Invite(user.UserId, user.FirstName + " " + user.LastName, user.Email, EmailTextBox.Text, user.SelectedOrganization.OrganizationId, GroupList.SelectedValue, MessageTextBox.Text);
