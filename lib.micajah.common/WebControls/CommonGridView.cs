...
namespace Micajah.Common.WebControls
{
    ...
    public class CommonGridView : GridView, IThemeable
    {
        ...
        private bool LastColumnIsAutoGenerated
        {
            get { return (this.AutoGenerateDeleteButton || (this.AutoGenerateEditButton && (this.Theme == MasterPageTheme.Modern))); }
        }
        ...
        private int StartCellsCount
        {
            get
            {
                ...
                if (this.AutoGenerateEditButton && (this.Theme != MasterPageTheme.Modern))
                    startCellsCount++;
        ...
        private void RenderHeaderRow(HtmlTextWriter writer, Control container)
        {
            ...
            if (this.HeaderGroupExists)
            {
                ...
                cellsCount--;
                if (this.LastColumnIsAutoGenerated && (cellIndex < cellsCount))
                {
        ...
        private static void RenderRow(HtmlTextWriter writer, GridViewRow row, int startCellsCount, int maxColSpan, bool lastColumnIsAutoGenerated, string borderColor, ref bool firstRow)
        {
            ...
            for (int columnIndex = 0; columnIndex < cellsCount; columnIndex++)
            {
                ...
                bool last = (columnIndex == (cellsCount - 1 - (lastColumnIsAutoGenerated ? 1 : 0)));
                ...
                {
                    additionalCellsCount = ((last && lastColumnIsAutoGenerated && deleteButtonCellIsRendered) ? 1 : 0);
                    if (last)
                    {
        ...
        private void RenderRows(HtmlTextWriter writer)
        {
            ...
            {
                firstRow = true;
                RenderRow(writer, this.Rows[rowIndex], startCellsCount, this.MaxColSpan, this.LastColumnIsAutoGenerated, borderColor, ref firstRow);
            }
        }
        ...
        /// </summary>
        /// <param name="dataSource">A PagedDataSource that represents the data sourceRow.</param>
        /// <param name="useDataSource">true to use the data sourceRow specified by the dataSource parameter; otherwise, false.</param>
        ...
        protected override ICollection CreateColumns(PagedDataSource dataSource, bool useDataSource)
        {
            ...
            if (this.LastColumnIsAutoGenerated)
            {
                autoGeneratedButtonsField = new AutoGeneratedButtonsField(this, (this.AutoGenerateEditButton && (this.Theme == MasterPageTheme.Modern)), this.AutoGenerateDeleteButton, false);
