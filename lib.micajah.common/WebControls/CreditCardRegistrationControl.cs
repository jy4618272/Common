...
namespace Micajah.Common.WebControls
{
    public class CreditCardRegistrationControl : Micajah.Common.WebControls.SetupControls.MasterControl
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), "FancyBoxInputScript", "$(\"input[value=" + FancyboxInputValue + "]\").fancybox({parent: 'form:first', type: 'inline', href: '#credit_card_form', width: 400, height: 'auto', arrows: false, openEffect: 'none', closeEffect: 'none'});", true);
        }

        private void RegisterFancyBoxHyperLinkScript()
        {
            ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), "FancyBoxHyperLinkScript", "$(\"a[rel=" + FancyboxHyperlinkRel + "]\").fancybox({parent: 'form:first', type: 'inline', href: '#credit_card_form', width: 400, height: 'auto', arrows: false, openEffect: 'none', closeEffect: 'none'});", true);
        }
