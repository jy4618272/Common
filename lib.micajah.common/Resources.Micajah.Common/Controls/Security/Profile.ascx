...
<mits:MagicForm ID="EditForm" runat="server" DataSourceID="EntityDataSource" DataKeyNames="UserId"
    ...
    <fields>
        ...
        <mits:TextBoxField DataField="Phone" MaxLength="20" Columns="20" ControlStyle-Width="180px" />
        <mits:TextBoxField DataField="MobilePhone" MaxLength="20" Columns="20" ControlStyle-Width="180px" />
        <mits:TextBoxField DataField="Fax" MaxLength="20" Columns="20" ControlStyle-Width="180px" />
        <mits:TextBoxField DataField="Title" MaxLength="20" Columns="20" ControlStyle-Width="180px" />
        ...
        <mits:TextBoxField DataField="PostalCode" MaxLength="20" Columns="20" ControlStyle-Width="180px" />
