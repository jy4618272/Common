...
Micajah.Common.ImageUpload = function(a) {
    Micajah.Common.ImageUpload.initializeBase(this, [a]);
    ...
    this._elementsToSynchronize = [["OriginalFileField", "value", false], ["CurrentFileField", "value", true], ["PreviousFilesField", "value", true], ["UploadedImage", "src", true], ["UploadedImage", "currentFileUrl", true]];
    this._enablePopupWindow = true;
    this._errorDivId = this.get_id() + "_ErrorPanel";
    this._errorMessages = [];
    this._panelCount = 0;
...
Micajah.Common.ImageUpload.prototype =
{
    ...
    _handleUploadedImageClick: function(args) {
        if (!this._enablePopupWindow)
            window.open($get(this._getUploadedImageId()).getAttribute("currentFileUrl"), "_blank");
    },
    ...
    dispose: function() {
        ...
        Micajah.Common.ImageUpload.callBaseMethod(this, "dispose");
    },

    initialize: function() {
        Micajah.Common.ImageUpload.callBaseMethod(this, "initialize");
...
Micajah.Common.ImageUpload.registerClass("Micajah.Common.ImageUpload", Sys.UI.Control);
