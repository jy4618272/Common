...
namespace Micajah.Common.Bll
{
    ...
    public static class MimeType
    {
        ...
        /// <returns>The MIME type string or null reference if the file extension is unknown.</returns>
        public static string GetMimeType(string fileExtension)
        {
            return GetMimeType(fileExtension, null);
        }
        ...
        /// </summary>
        /// <param name="fileExtension">A file extension.</param>
        /// <param name="defaultMimeType">The MIME type to return if the file extension is unknown.</param>
        /// <returns>The MIME type string or default, if the file extension is unknown.</returns>
        public static string GetMimeType(string fileExtension, string defaultMimeType)
        {
